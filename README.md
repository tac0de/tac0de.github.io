...
- `/games/cards/`는 Three.js tabletop 형태의 Stacklands-inspired card survival prototype
- 카드 게임은 3D tabletop card dragging, proximity placement, worker routine, timed production, dusk event, day hunger loop 지원
- 모바일 우선 1인칭 탐색
